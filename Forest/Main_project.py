...
#     r"E:\forest\Project\830", file_head, file_mid, file_end, Polarization, 20240829, 105058528)
#
# array_HH_909, array_VV_909, array_HV_909, array_VH_909 = input_data.read_data_from_file(
#     r"E:\forest\Project\909", file_head, file_mid, file_end, Polarization, 20240906, 105435075)
#
# #获取影像行列数
...
#     "E:/forest/Project/Forest/array_830_k1.h5",
#     "E:/forest/Project/Forest/array_830_k1_T.h5",
#     row,col,
#     'array_830_k1',
#     'array_830_k1_T')
...
#     "E:/forest/Project/Forest/array_909_k2.h5",
#     "E:/forest/Project/Forest/array_909_k2_T.h5",
#     row,col,
#     'array_909_k2',
#     'array_909_k2_T'
# )
...
# print("-------- 辅图像k2计算结束 ----------")
# # 读取保存的h5结果
# with h5py.File("array_830_k1.h5",'r',) as f:
#     array_830_k1 = f['array_830_k1'][:]
#     print(array_830_k1.shape)
#
# with h5py.File("array_830_k1_T.h5",'r') as f:
...
#     print("T11计算完成，并保存结果")
# with h5py.File("array_909_k2.h5", 'r') as f:
#     array_909_k2 = f['array_909_k2'][:]
# with h5py.File("array_909_k2_T.h5", 'r') as f:
...
with h5py.File("E:/forest/Project/Forest/Omage12.h5",'w') as f:
    Omage12 = f.create_dataset("T22",data=Omage12,dtype=Omage12.dtype)
    print("Omage12计算完成，并保存结果")
# """
#     创建新矩阵,计算T6、以及复相干优化
# """
# print("-------- T6、复相干优化----------")
