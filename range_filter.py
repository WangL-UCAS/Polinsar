...
x_spacing = 3.87737348876680254505799894105
 # 斜距方向像素间距 (m)
...
#读取配准数据
array_830 = read_gdal_array("830/saocom_20240829_105058528_QS6_D_VV_slc_rsp")
array_909 = read_gdal_array("909/saocom_20240906_105435075_QS6_D_VV_slc_rsp")
#读取视角信息
...
range_near_830 = 696371.072  # 最近距离
range_near_909 = 696385.990
#计算
...
f_830 = f_fix(array_830.shape, angle_830,slope_angle_830,range_near_830,x_spacing)
f_909 = f_fix(array_909.shape, angle_909,slope_angle_909,range_near_909,x_spacing)
...
# 保存 830 和 909 结果
save_complex_as_complex("filtered_image_830_complex.dat", filtered_image_830, "830/saocom_20240829_105058528_QS6_D_VV_slc_rsp")
save_complex_as_complex("filtered_image_909_complex.dat", filtered_image_909, "909/saocom_20240906_105435075_QS6_D_VV_slc_rsp")
